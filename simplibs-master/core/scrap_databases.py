...
def read_lines_NIST(element):
    ...
    filename = 'core/database/libs_data_NIST/'+element+'.txt'
...
def read_lines_Kurucz(element):
    ...
    #gather data
    #read data from database
    filename = 'core/database/libs_data_Kurucz/by_element/'+element+'.txt'
    lines_df = pd.read_csv(filename,sep=',')
...
def read_ion_properties(element_label):
    ...
    #gather data
    #read data from database
    filename = 'core/database/element_data/ion_Data.csv'
